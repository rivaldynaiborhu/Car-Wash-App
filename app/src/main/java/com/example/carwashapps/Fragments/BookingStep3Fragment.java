...
import com.example.carwashapps.Adapter.MyTimeSlotAdapter;
import com.example.carwashapps.Common.Common;
import com.example.carwashapps.Common.SpacesItemDecoration;
import com.example.carwashapps.Interface.ITimeSlotLoadListener;
...
public class BookingStep3Fragment extends Fragment implements ITimeSlotLoadListener {
    ...
    BroadcastReceiver displayTimeSlot = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            loadAvailableTimeSlotOfWorker(Common.currentWorker.getWorkerId(),
                    simpleDateFormat.format(date.getTime()));
        }
    };

    private void loadAvailableTimeSlotOfWorker(String workerId, final String bookDate) {
        dialog.show();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        simpleDateFormat = new SimpleDateFormat("dd_MM_yyyy"); // ini key
    ...
    private void init(View itemView) {
        ...
        horizontalCalendar.setCalendarListener(new HorizontalCalendarListener() {
            ...
            public void onDateSelected(Calendar date, int position) {
                ...
                {
                    Common.currentDate = date; // kode ini gabakal kelihatan lagi kalau udah milih hari yang sama dengan hari yang udah dipilih
                    loadAvailableTimeSlotOfWorker(Common.currentWorker.getWorkerId(),
                            simpleDateFormat.format(date.getTime()));
                }
            }
